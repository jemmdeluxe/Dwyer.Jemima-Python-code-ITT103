...
#https://github.com/jemmdeluxe/Dwyer.Jemima-PythonCode-ITT103-S2022/blob/main/Dwyer.Jemima-PythonCode-ITT103-S2022.py

salepId = int(input("Enter your Sales Person ID number: " ))
while salepId < 10000:
    print(input("Please enter a valid Sales Person ID."))
    break
...
while classTp == 1:
    if sales_amnt <= 1000:
        ...
        print("For",str(saleId)+ " your commission is", + int(comAmount))
        break
    else: 
        sales_amnt >= 2000
